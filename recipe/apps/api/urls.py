...
custom_urlpatterns = [
    ...
    url(r'public-recipes/(?P<pk>\d+)/reviews/$', RecipeReviews.as_view({'get': 'list', 'post': 'create'}),
        name='recipe_reviews'),
    url(r'public-recipes/(?P<pk>\d+)/upvotes/$', UpVoteViewSet.as_view({'get': 'list', 'post': 'create'}),
        name='recipe_upvotes'),
]
