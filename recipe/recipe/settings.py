...
SECRET_KEY = 'q_k&0f$qdmn)@ub*1j7hto0%b*b1pql%tq=(0pz=yeoc!z0y35'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'apps.authentication',  # I added this line
    'apps.api',
]
...
# Means, tell the Django that we're using custom user model
